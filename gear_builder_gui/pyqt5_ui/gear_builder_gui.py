...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_input_delete.setGeometry(QtCore.QRect(210, 390, 61, 21))
        ...
        self.btn_config_edit.setGeometry(QtCore.QRect(150, 450, 51, 21))
        ...
        self.btn_input_edit.setGeometry(QtCore.QRect(150, 390, 51, 21))
        self.btn_input_edit.setObjectName("btn_input_edit")
        self.cmbo_inputs = QtWidgets.QComboBox(self.tb_manifest)
        self.cmbo_inputs.setGeometry(QtCore.QRect(100, 360, 171, 26))
        ...
        self.cmbo_config.setGeometry(QtCore.QRect(102, 420, 171, 26))
        ...
        self.txt_simple_script = QtWidgets.QLineEdit(self.tb_scripts)
        self.txt_simple_script.setGeometry(QtCore.QRect(10, 70, 171, 21))
        self.txt_simple_script.setObjectName("txt_simple_script")
        self.label_16 = QtWidgets.QLabel(self.tb_scripts)
        self.label_16.setGeometry(QtCore.QRect(10, 50, 151, 16))
        ...
        MainWindow.setTabOrder(self.cbo_script_template, self.txt_simple_script)
        MainWindow.setTabOrder(self.txt_simple_script, self.btn_export_gear)
...
"notify on pep8 violations(??)"))
        ...
        self.cbo_script_template.setItemText(0, _translate("MainWindow", "Simple Script"))
        self.cbo_script_template.setItemText(1, _translate("MainWindow", "Build/Validate/Execute"))
